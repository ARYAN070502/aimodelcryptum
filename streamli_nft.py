...
nft_data['total_price'] = pd.to_numeric(nft_data['total_price'], errors='coerce')
...
# Main Function
def main():
    st.title("Welcome to CYRYPTUM's Own Price Predictor And Market Analyser!")
    

    menu = ["Home", "Price Predictor", "Market Analysis", "User/Trader Analysis", "NFT Categories"]
